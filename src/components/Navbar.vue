<template>
  <main class="navbar dark:from-slate-900 dark:to-slate-900">
    <section class="navbar-brand">
      ...
      <button
        @click="showMenu = true"
        class="active:scale-90 duration-300 md:hidden"
        type="button"
      >
    ...
    <section :class="showMenu ? 'right-0' : '-right-full'" class="navbar-menu">
      <ul class="navbar-list">
        ...
        <li
          class="md:hidden w-full bg-green-500 dark:md:bg-green-600 mt-5 text-gray-100 text-center py-2 px-4 rounded-lg"
        >
          <a href="https://wa.me/6281368344612">
      ...
      <section
        class="hidden md:block bg-green-500 text-gray-100 text-center p-2 md:px-4 rounded-lg"
      >
        <a href="https://wa.me/6281368344612">
          <i class="fab fa-whatsapp"></i>
          Chat me
